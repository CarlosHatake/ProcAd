<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="55.aspx.vb" Inherits="ProcAd._55" %>
    ...
    <table style="width: 1366px; font-family: Verdana; font-size: 8pt;">
        <tr>
            <td style="text-align: center; color: #FF0000;">
                <ig:WebScriptManager ID="wsm55" runat="server">
                </ig:WebScriptManager>
                ...
                <asp:TextBox ID="_txtRFC" runat="server" Width="15px" Visible="False"></asp:TextBox>
                ...
                <asp:Panel ID="pnlInicio" runat="server">
                    ...
                    <table style="width: 1366px; height: 44px;">
                        <tr>
                            ...
                            <td class="auto-style10" style="text-align: right; ">
                                <asp:Label ID="lbl_FechaSol" runat="server" Text="Fecha Solicitud:"></asp:Label>
                            </td>
                            <td class="auto-style8">
                                <asp:Label ID="lblFechaSol" runat="server" ForeColor="Blue" Width="280px"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblFechaIni" runat="server" ForeColor="Blue"></asp:Label>
                            </td>
                            <td style="text-align: right">
                                <asp:Label ID="lbl_FechaTer" runat="server" Text="Fecha Término:"></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="lblFechaTer" runat="server" ForeColor="Blue"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style5" style="text-align: right">
                                <asp:Label ID="lbl_Periodicidad" runat="server" Text="Periodicidad:"></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="lblPeriodicidad" runat="server" ForeColor="Blue"></asp:Label>
                            </td>
                            <td style="text-align: right">
                                <asp:Label ID="lbl_MontoXPeriodo" runat="server" Text="Monto por Periodo:"></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="lblMontoXPeriodo" runat="server" ForeColor="Blue"></asp:Label>
                            </td>
                            <td style="text-align: right">
                                <asp:Label ID="lbl_MontoContrato" runat="server" Text="Monto del Contrato:"></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="lblMontoContrato" runat="server" ForeColor="Blue"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style5" style="text-align: right">
                    ...
                    <table style="width: 1366px; height: 44px;">
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblLugar" runat="server" ForeColor="Blue" Width="1072px"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right">
                                <asp:Label ID="lbl_Especificaciones" runat="server" Text="Descripción:"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtEspecificaciones" runat="server" Height="79px" ReadOnly="True" TextMode="MultiLine" Width="1072px" Font-Names="Verdana" Font-Size="8pt"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right">
                            ...
                            <td>
                                <asp:TextBox ID="txtComentario" runat="server" Height="52px" MaxLength="350" TextMode="MultiLine" Width="1072px" Font-Names="Verdana" Font-Size="8pt"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
