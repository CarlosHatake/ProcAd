                ...
                <asp:Panel ID="pnlInicio" runat="server">
                                ...
                                <asp:Panel runat="server" ID="pnlInformacionGeneral">
                                    ...
                                    <td>
                                        <asp:UpdatePanel runat="server" ID="updCC" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                 <asp:DropDownList ID="ddlCC" runat="server" Width="190px" Visible ="false" AutoPostBack="true"> </asp:DropDownList>
                                            </ContentTemplate>
                                        </asp:UpdatePanel> 
                                    </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:UpdatePanel runat="server" ID="upAutorizador">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlAutorizador" runat="server" Width="190px" Visible="false"></asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </td>
                                            <td style="width:20px"></td>
                                            ...
                                            <td>
                                                <asp:UpdatePanel runat="server" ID="upDiv" UpdateMode="Conditional" >
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlDiv" runat="server" Width="190px" Visible="false" AutoPostBack="true"></asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:UpdatePanel runat="server" ID="up_Autorizador2">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlAutorizador2" runat="server" Width="190px" Visible="false"></asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </td>
                                           <td style="width:20px"></td>
                                            ...
                                            <td>
                                                <table style="width: 100%">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:ImageButton ID="ibtnBuscarProveedor" runat="server" ImageUrl="images\icn_search.png" Visible="false"/>
                                                        </td>
                                                    </tr>
                                                </table>
                                                </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:UpdatePanel runat="server" ID="upAutorizador3">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlAutorizador3" runat="server" Width="190px" Visible="false"></asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </td>
                                            <td style="width:20px"></td>
                                            ...
                                            <td>
                                                <asp:UpdatePanel runat="server" ID="upProveedor" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlProveedor" runat="server" Width="200px" Visible="false" AutoPostBack="True"></asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>

                                            </td>
                                            <td style="width: 40px; vertical-align: top;text-align:right">
                                                <asp:ImageButton ID="ibtnAltaProveedor" runat="server" ImageUrl="images\Add.png" ToolTip="Alta" Width="20px" />
                                            </td>
                                            <td style="width: 30px; vertical-align: top;text-align:right">
                                                <asp:ImageButton ID="ibtnBajaProveedor" runat="server" ImageUrl="images\Trash.png" ToolTip="Baja" Width="20px" />
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                  ...
                  <%--  <asp:Panel ID="pnlAnticipoConPedidoCompra" runat="server" Visible="false">
                   ...
                   <%-- <asp:Panel ID="pnlPagoAnticipadoSinPedidosCompra" runat="server" Visible="false">
                    ...
                    <asp:Panel ID="pnlPagoAnticipadoAgenteAduanal" runat="server" Visible="False">
                        <table style="width: 1366px; height: 40px">
                           <tr>
                        ...
                        <table style="width: 1366px; height: 40px">
                            <tr>
                                <td style="height: 100px; width: 120px"></td>
                                <td style="width: 110px; text-align: right">
                                    <asp:Label ID="lbl_CFDIAnticipoAgenteAduanal" runat="server" Text="CFDI ANTICIPO:" Font-Bold="true"></asp:Label>
                                </td>
                                <td style="width: 700px">
                                    <asp:GridView ID="gvAgenteAduanal" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Font-Names="Verdana" Font-Size="7pt" ForeColor="Black" GridLines="Horizontal" Width="700px" DataKeyNames="id_dt_factura">
                                        <Columns>
                                            <%--<asp:BoundField DataField="id" HeaderText="idCFDI" />--%>
                                            <asp:CommandField ButtonType="Image" SelectImageUrl="images\ok.png" ShowSelectButton="True">
                                                <ItemStyle Width="15px" />
                                ...
                                <td>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td style="vertical-align: top; width: 190px">
                                                    <asp:FileUpload ID="fuEvidenciaAgenteAduanal" runat="server" Font-Names="Verdana" Font-Size="8pt" Width="180px" />
                                                </td>
                                    ...
                                    <asp:UpdatePanel runat="server" ID="upGvEvidencias" Visible="false">
                                        <ContentTemplate>
                                            <table>
                                                <tr>
                                                    <td>&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td style="vertical-align:top">
                                                        <asp:GridView ID="gvEvidencias" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Font-Names="Verdana" Font-Size="7pt" ForeColor="Black" GridLines="Horizontal" Width="320px" DataKeyNames="id_dt_archivo_adj_comp_anticipo, nombre">
                                                            <Columns>
