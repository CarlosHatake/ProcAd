    ...
    Protected Sub btnAutorizar_Click(sender As Object, e As EventArgs) Handles btnRegistrar.Click
        With Me
            Try
                ...
                If ._txtTipo_pago.Text = "2" And .gvPedidosCompras.Rows.Count > 0 Then
