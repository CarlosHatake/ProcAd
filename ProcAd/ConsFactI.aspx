<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="ConsFactI.aspx.vb" Inherits="ProcAd.ConsFactI" %>
                ...
                <asp:Panel ID="pnlFiltros" runat="server">
                    ...
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td style="text-align: left; width: 130px;">
                                <asp:CheckBox ID="cbFechaE" runat="server" AutoPostBack="True" Font-Names="Verdana" Font-Size="8pt" Text="Fecha Emisión:" />
                            </td>
                            <td>
                                <asp:Panel ID="pnlFechaE" runat="server" Width="350px">
                                    <table style="width:260px;">
                                        <tr>
                                            <td style="border: medium inset #808080; margin-right: auto; margin-left: auto;">
                                                <table style="width: 127px;">
                                                    <tr>
                                                        <td style="text-align: center">
                                                            <asp:Label ID="lbl_FechaEI" runat="server" Text="Fecha Inicial"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align: center">
                                                            <ig:WebDatePicker ID="wdpFechaEI" runat="server" Font-Names="Verdana" Font-Size="8pt" MinValue="2014-08-06" Nullable="False" Width="120px">
                                                            </ig:WebDatePicker>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="border: medium inset #808080; margin-right: auto; margin-left: auto;">
                                                <table style="width: 127px;">
                                                    <tr>
                                                        <td style="text-align: center">
                                                            <asp:Label ID="lbl_FechaEF" runat="server" Text="Fecha Final"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align: center">
                                                            <ig:WebDatePicker ID="wdpFechaEF" runat="server" Font-Names="Verdana" Font-Size="8pt" MinValue="2014-08-06" Nullable="False" Width="120px">
                                                            </ig:WebDatePicker>
                                                        </td>
                                                    </tr>
                                                </table>
                ...
                <asp:Panel ID="pnlDetalle" runat="server">
                    ...
                    <table style="width: 1366px; height: 44px;">
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:Label ID="lblRegimenF" runat="server" ForeColor="Blue" Width="550px"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right">
                            ...
                            <td>
                                <asp:Label ID="lblDescrip" runat="server" ForeColor="Blue" Width="500px"></asp:Label>
                            </td>
                            ...
                            <td class="auto-style50" style="text-align: right">
                                <asp:Label ID="lbl_Contrato" runat="server" Text="Contrato:"></asp:Label>
                            </td>
                            <td class="auto-style51">
                                <asp:Label ID="lblContrato" runat="server" ForeColor="Blue" Width="170px"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right">
                            ...
                            <td colspan="5">
                                <asp:TextBox ID="txtEspecificaciones" runat="server" Height="52px" ReadOnly="True" TextMode="MultiLine" Width="1072px"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                    <table style="width: 1366px; height: 22px;">
                        <tr>
                            ...
                            <td style="width: 150px; ">
                                <asp:Label ID="lblTipo" runat="server" ForeColor="Blue" Width="140px"></asp:Label>
                            </td>
                            <td style="text-align: right; width: 120px; height: 21px;">
                    ...
                    <table style="width: 1366px; height: 22px;">
                        <tr>
                            ...
                            <td style="width: 180px; ">
                                <asp:Label ID="lblSubtotal" runat="server" ForeColor="Blue" Width="170px"></asp:Label>
                            </td>
                            <td style="text-align: right; width: 120px; height: 21px;">
                    ...
                    <table style="width: 100%; text-align: center; margin-right: auto; margin-left: auto; height: 60px;">
                        <tr>
                            <td class="auto-style51">
                                <asp:Button ID="btnRegNAV" runat="server" Font-Names="Verdana" Font-Size="8pt" Text="Registrado en NAV" Width="180px" />
                            </td>
                            <td class="auto-style51">
                                <asp:Button ID="btnRechaza" runat="server" Font-Names="Verdana" Font-Size="8pt" OnClick="btnRechaza_Click" OnClientClick="this.disabled = true;" Text="Rechazar" UseSubmitBehavior="false" Width="180px" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
