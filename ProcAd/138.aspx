<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="138.aspx.vb" Inherits="ProcAd._138" %>
    ...
    <table style="width: 1366px; font-family: Verdana; font-size: 8pt;">
        <tr>
            <td style="text-align: center; color: #FF0000;">
                ...
                <asp:TextBox ID="_txtTipo_pago" runat="server" Width="15px" Visible="False"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Panel runat="server" ID="pnlInicio">
                    ...
                    <table style="width: 1366px; height: 44px;">
                        ...
                        <tr>
                            ...
                            <td style="width: 550px">
                                <asp:Label ID="lblSolicitante" runat="server" ForeColor="Blue" Font-Bold="true"></asp:Label>                                
                            </td>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblFechaPago" runat="server" ForeColor ="Blue" Font-Bold="true"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <table style="width: 1200px; height: 104px;">
                        <tr>
                            <td style="text-align: center">
                                <asp:Button ID="btnRegistrar" runat="server" Text="Registrar Pago" Width="200px" OnClientClick="this.disabled = true; this.value='Procesando…';" UseSubmitBehavior="false" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
