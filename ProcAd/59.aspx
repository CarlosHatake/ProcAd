<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="59.aspx.vb" Inherits="ProcAd._59" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width: 1366px; font-family: Verdana; font-size: 8pt;">
                ...
                <asp:Panel ID="pnlInicio" runat="server">
                    ...
                    <table style="width: 1360px; height: 22px;">
                        <tr>
                            ...
                            <td style="width: 150px">
                                <asp:Label ID="lblEmpresa" runat="server" ForeColor="Blue" Width="145px"></asp:Label>
                            </td>
                                    ...
                                    <asp:Panel ID="pnlAnticipo" runat="server">
                                        <table style="width: 670px; ">
                                                ...
                                                <td style="text-align: center">
                                                    <table style="width:100%;">
                                                        <tr>
                                                            ...
                                                            <td style="text-align: left">
                                                                <asp:DropDownList ID="ddlTipoHospedaje" runat="server" Font-Names="Verdana" Font-Size="8pt" Width="170px">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left">
                                                    <asp:Label ID="lblOtros" runat="server" Font-Bold="True" ForeColor="#003399" Width="265px"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: right">
                                                ...
                                                <td style="text-align: left">
                                                    <asp:Label ID="lblMontoTLetra" runat="server" Font-Italic="True" Width="265px"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
        ...
        <tr>
            <td>
                    <table style="width: 1366px; height: 44px;" __designer:mapid="5ad">
                        <tr __designer:mapid="5ae">
                            <td class="auto-style5" style="text-align: right" __designer:mapid="5af">
                                <asp:Label ID="lbl_Comentario" runat="server" Text="Comentarios:"></asp:Label>
                            </td>
                            <td __designer:mapid="5b1">
