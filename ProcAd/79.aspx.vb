                ...
                Try
                    ...
                    If Session("litError") = "" And Val(Session("id_usuario")) > 0 Then
                        ...
                        sdaEvaluaciones.SelectCommand = New SqlCommand("select id_ms_evaluacion " + _
                                                                       ...
                                                                       "  and año_eval = @año " + _
                                                                       "  and status in ('PCE', 'PPE', 'EP') " + _
                                                                       "  and fecha_nomina_1ra is null " + _
                                                                       "order by empresa, ms_evaluacion.direccion, centro_costo, colaborador ", ConexionBD)
            ...
            Try
                ...
                While Val(._txtBan.Text) = 0
                    ...
                    For i = 0 To .gvEvaluaciones.Rows.Count - 1
                        'Actualizar ID Usr y Fecha de Nómina 1ra Quincena de las Evaluaciones Individuales
                        SCMValores.Parameters.Clear()
                        SCMValores.CommandText = "update ms_evaluacion  " + _
                                                 "  set id_usr_nomina_1ra = @id_usr_nomina_1ra, fecha_nomina_1ra = @fecha_nomina_1ra " + _
                                                 "where id_ms_evaluacion = @id_ms_evaluacion "
                        SCMValores.Parameters.AddWithValue("@id_usr_nomina_1ra", Val(._txtIdUsuario.Text))
                        SCMValores.Parameters.AddWithValue("@fecha_nomina_1ra", fecha)
