<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="17.aspx.vb" Inherits="ProcAd._17" %>
    ...
    <table style="width: 1366px; font-family: Verdana; font-size: 8pt;">
        <tr>
            <td style="text-align: center; color: #FF0000;">
                <ig:WebScriptManager ID="wsm17" runat="server">
                </ig:WebScriptManager>
                ...
                <asp:TextBox ID="_txtIdAut" runat="server" Width="15px" Visible="False"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Panel ID="pnlInicio" runat="server">
                    ...
                    <table style="width: 1366px; height: 44px;">
                        ...
                        <tr>
                            <td class="auto-style5" style="text-align: right">
                                <asp:Label ID="lbl_TablaComp2" runat="server" Text="Nuevo Archivo:" Width="110px"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="auto-style5" style="text-align: right">
                                <asp:Label ID="lbl_AdjOpc2" runat="server" Text="Nuevo Archivo:" Width="110px"></asp:Label>
                            </td>
                            <td>
                    ...
                    <table style="width: 1366px; height: 50px;">
                        <tr>
                            <td style="text-align: center">
                                <asp:Button ID="btnGuardar" runat="server" Font-Names="Verdana" Font-Size="8pt" OnClick="btnGuardar_Click" OnClientClick="this.disabled = true;" Text="Solicitar Autorización" UseSubmitBehavior="false" Width="200px" />
                            </td>
                            <td style="text-align: center">
                                <asp:Button ID="btnCancelar" runat="server" Font-Names="Verdana" Font-Size="8pt" OnClick="btnCancelar_Click" OnClientClick="this.disabled = true;" Text="Cancelar Solicitud" UseSubmitBehavior="false" Width="200px" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
