<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="09a.aspx.vb" Inherits="ProcAd._09a" %>
    ...
    <table style="width: 1366px; font-family: Verdana; font-size: 8pt;">
        <tr>
            <td style="text-align: center; color: #FF0000; width: 1366px;">
                <ig:WebScriptManager ID="wsm09" runat="server">
                </ig:WebScriptManager>
                ...
                <asp:TextBox ID="_txtIdUsrAut" runat="server" Width="15px" Visible="False"></asp:TextBox>
        ...
        <tr>
            <td>
                <asp:Panel ID="pnlInicio" runat="server">
                    ...
                    <table style="width: 1366px; height: 44px;">
                        <tr>
                            <td style="width: 921px; height: 30px; vertical-align: top;">
                                <table style="width:100%;">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtJust" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="56px" ReadOnly="True" TextMode="MultiLine" Width="735px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: right">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtObsAut" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="56px" TextMode="MultiLine" Width="735px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: right">
                                ...
                                <table style="width:100%;">
                                    <tr>
                                        <td style="width: 115px; text-align: right;">
                                            <asp:Label ID="lbl_AnticiposG" runat="server" Text="Anticipos:"></asp:Label>
                                        </td>
                                        <td>
                                            ...
                                            <asp:Label ID="lblAnticiposN" runat="server" Font-Italic="True" Text="No hay"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: right;">
                                        ...
                                        <td>
                                            <table style="width: 98%;">
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="gvEvidencias" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Font-Names="Verdana" Font-Size="7pt" ForeColor="Black" GridLines="Horizontal" Width="295px">
                                                            <Columns>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:GridView ID="gvValeI" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" ShowHeader="False" Width="300px">
                                                <AlternatingRowStyle BackColor="#CCCCCC" />
                                                <Columns>
                                                    <asp:HyperLinkField DataNavigateUrlFields="path" DataTextField="Vale" HeaderText="Vale">
                                            ...
                                            <asp:Label ID="lblValeIN" runat="server" Font-Italic="True" Text="No hay"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td>
                                <asp:GridView ID="gvConceptos" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" GridLines="Vertical" Width="1345px">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="id_dt_comp" HeaderText="id_dt_comp" />
                                        ...
                                        <asp:TemplateField HeaderText="No Válido">
                                            <ItemTemplate>
                    ...
                    <table style="width: 1366px; height: 50px;">
                        <tr>
                            ...
                            <td style="text-align: center; ">
                                <asp:Button ID="btnRegresar" runat="server" Font-Names="Verdana" Font-Size="8pt" OnClick="btnRegresar_Click" OnClientClick="this.disabled = true;" Text="Regresar para Corregir" UseSubmitBehavior="false" Width="200px" />
                            </td>
                            <td style="text-align: center; ">
