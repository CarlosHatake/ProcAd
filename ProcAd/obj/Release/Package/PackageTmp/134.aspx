<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="134.aspx.vb" Inherits="ProcAd._134" %>
    ...
    <table style="width: 1366px; font-family: Verdana; font-size: 8pt;">
        <tr>
            <td style="text-align: center; color: #FF0000;">
                ...
                <asp:TextBox ID="_txtRFCProveedor" runat="server" Width="15px" Visible="False"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="text-align: center; color: #FF0000;">
                        ...
                        <tr>
                            ...
                            <td>
                                <table style="width: 100%">
                                    <tr>
                                        <td>
                                             <asp:UpdatePanel ID="upImpo" runat="server" UpdateMode="Conditional">
                                                 <ContentTemplate>
                            ...
                            <tr>
                                ...
                                <td style="width: 535px; vertical-align: top">
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td>
                                                <asp:GridView ID="gvEvidencias" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Font-Names="Verdana" Font-Size="7pt" ForeColor="Black" GridLines="Horizontal" Width="250px">
                                                    <Columns>
