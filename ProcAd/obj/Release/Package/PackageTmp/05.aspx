<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="05.aspx.vb" Inherits="ProcAd._05" %>
    ...
    <table style="width: 1360px; font-family: Verdana; font-size: 8pt;">
        <tr>
            <td style="text-align: center; color: #FF0000;">
                <ig:WebScriptManager ID="wsm05" runat="server">
                </ig:WebScriptManager>
            ...
            <td>
                <asp:Panel ID="pnlInicio" runat="server">
                    ...
                    <table style="width: 1360px; height: 60px;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">
                                <ig:WebNumericEditor ID="wneDiasH" runat="server" Font-Names="Verdana" Font-Size="8pt" Width="70px" ReadOnly="True" Height="21px">
                                </ig:WebNumericEditor>
                            </td>
                            <td style="text-align: center">
                    ...
                    <table style="width: 1360px; height: 50px;">
                        <tr>
                            <td style="text-align: center">
                                <asp:Button ID="btnAceptar" runat="server" Font-Names="Verdana" Font-Size="8pt" Text="Efectivo Entregado" Width="200px" OnClientClick="this.disabled = true; this.value='Procesando…';" UseSubmitBehavior="false" OnClick ="btnAceptar_Click" />
                            </td>
                        </tr>
                    </table>
                      <table style="width: 1360px; height: 50px;">
                        <tr>
                            <td style="text-align: center">
                                <asp:Button ID="Button1" runat="server" Font-Names="Verdana" Font-Size="8pt" Text="Efectivo Entregado" Width="200px" OnClientClick="this.disabled = true; this.value='Procesando…';" UseSubmitBehavior="false" OnClick ="btnAceptar_Click" />
                            </td> 
                            <td style="text-align: center">
                                <asp:Button ID="Button2" runat="server" Font-Names="Verdana" Font-Size="8pt" Text="Efectivo Entregado" Width="200px" OnClientClick="this.disabled = true; this.value='Procesando…';" UseSubmitBehavior="false" OnClick ="btnAceptar_Click" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
