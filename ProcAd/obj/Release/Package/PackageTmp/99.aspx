<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="99.aspx.vb" Inherits="ProcAd._99" %>
    ...
    <table style="width: 1366px; font-family: Verdana; font-size: 8pt;">
        <tr>
            <td style="text-align: center; color: #FF0000;">
                <ig:WebScriptManager ID="wsm99" runat="server">
                </ig:WebScriptManager>
                ...
                <asp:Panel ID="pnlInicio" runat="server">
                    ...
                    <table style="width: 1366px; height: 44px;">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtComentario" runat="server" Height="52px" MaxLength="350" ReadOnly="True" TextMode="MultiLine" Width="1072px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
