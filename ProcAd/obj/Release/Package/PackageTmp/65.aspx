<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="65.aspx.vb" Inherits="ProcAd._65" %>
    ...
    <table style="width: 1366px; font-family: Verdana; font-size: 8pt;">
        <tr>
            <td style="text-align: center; color: #FF0000;">
                <ig:WebScriptManager ID="wsm65" runat="server">
                </ig:WebScriptManager>
                ...
                <asp:Panel ID="pnlInicio" runat="server">
                    ...
                    <table style="width: 1360px; height: 50px;">
                        <tr>
                            ...
                            <td style="text-align: center">
                                <asp:Button ID="btnEnviar" runat="server" Font-Names="Verdana" Font-Size="8pt" OnClick="btnEnviar_Click" OnClientClick="this.disabled = true; this.value='Procesando…';" Text="Enviar a Comprobaciones" UseSubmitBehavior="false" Width="200px" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
