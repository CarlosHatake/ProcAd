<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="15.aspx.vb" Inherits="ProcAd._15" %>
            ...
            <td>
                <asp:Panel ID="pnlInicio" runat="server">
                    ...
                    <table style="width: 1366px; height: 44px;">
                        ...
                        <tr>
                            <td class="auto-style5" style="text-align: right">
                                <asp:Label ID="lbl_Descripcion" runat="server" Text="Descripción:" Width="110px"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtDescripcion" runat="server" Font-Names="Verdana" Font-Size="8pt" Width="800px"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
