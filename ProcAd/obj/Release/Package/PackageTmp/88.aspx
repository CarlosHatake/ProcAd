<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="88.aspx.vb" Inherits="ProcAd._88" %>
    ...
    <table style="width: 1366px; font-family: Verdana; font-size: 8pt;">
        <tr>
            <td style="text-align: center; color: #FF0000;">
                <ig:WebScriptManager ID="wsm88" runat="server">
                </ig:WebScriptManager>
                ...
                <asp:TextBox ID="_txtNombreUsr" runat="server" Width="15px" Visible="False"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Panel ID="pnlInicio" runat="server">
                    ...
                    <table style="width: 1366px; height: 44px;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: right">
                                <asp:Label ID="lbl_Vigencia" runat="server" Text="Vigencia"></asp:Label>
                            </td>
                            <td>
                    ...
                    <table style="width: 1366px; height: 44px;">
                        <tr>
                            <td class="auto-style5" style="text-align: right">
                                <asp:Label ID="lbl_ComentarioGC" runat="server" Text="Comentarios Ger. Comp."></asp:Label>
                            </td>
                            <td class="auto-style8">
                            ...
                            <td style="text-align: center">
                                <table style="width:100%;">
                                    <tr>
                                        ...
                                        <td style="width: 80px">
                                            <asp:Label ID="lbl_Cantidad" runat="server" Text="Cantidad" Width="60px"></asp:Label>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ig:WebNumericEditor ID="wneCantidad1" runat="server" Font-Names="Verdana" Font-Size="8pt" Nullable="False" Width="60px">
                                            </ig:WebNumericEditor>
                                        </td>
                                        <td>
                                            <ig:WebCurrencyEditor ID="wceImporte1" runat="server" font-names="Verdana" font-size="8pt" maxdecimalplaces="4" minvalue="0.01" width="90px">
                                        ...
                                        <td>
                                            <ig:WebDatePicker ID="wdpFechaIni1" runat="server" Width="110px">
                                            </ig:WebDatePicker>
                                        </td>
                                        <td>
                                            <ig:WebDatePicker ID="wdpFechaFin1" runat="server" Width="120px">
                                            </ig:WebDatePicker>
                                        </td>
                                        <td>
                                            <asp:DropDownList ID="ddlCondP1" runat="server" Font-Names="Verdana" Font-Size="8pt" Width="110px">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                            <asp:FileUpload ID="fuPDF1" runat="server" Font-Names="Verdana" Font-Size="8pt" Width="220px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: center">
                                        ...
                                        <td>
                                            <ig:WebNumericEditor ID="wneCantidad2" runat="server" Font-Names="Verdana" Font-Size="8pt" Nullable="False" Width="60px">
                                            </ig:WebNumericEditor>
                                        </td>
                                        <td>
                                            <ig:WebCurrencyEditor ID="wceImporte2" runat="server" font-names="Verdana" font-size="8pt" maxdecimalplaces="4" minvalue="0.01" width="90px">
                                            </ig:WebCurrencyEditor>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <ig:WebDatePicker ID="wdpFechaIni2" runat="server" Width="110px">
                                            </ig:WebDatePicker>
                                        </td>
                                        <td>
                                            <ig:WebDatePicker ID="wdpFechaFin2" runat="server" Width="120px">
                                            </ig:WebDatePicker>
                                        </td>
                                        <td>
                                            <asp:DropDownList ID="ddlCondP2" runat="server" Font-Names="Verdana" Font-Size="8pt" Width="110px">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                            <asp:FileUpload ID="fuPDF2" runat="server" Font-Names="Verdana" Font-Size="8pt" Width="220px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: center">
                                        ...
                                        <td>
                                            <ig:WebNumericEditor ID="wneCantidad3" runat="server" Font-Names="Verdana" Font-Size="8pt" Nullable="False" Width="60px">
                                            </ig:WebNumericEditor>
                                        </td>
                                        <td>
                                            <ig:WebCurrencyEditor ID="wceImporte3" runat="server" font-names="Verdana" font-size="8pt" maxdecimalplaces="4" minvalue="0.01" width="90px">
                                            </ig:WebCurrencyEditor>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <ig:WebDatePicker ID="wdpFechaIni3" runat="server" Width="110px">
                                            </ig:WebDatePicker>
                                        </td>
                                        <td>
                                            <ig:WebDatePicker ID="wdpFechaFin3" runat="server" Width="120px">
                                            </ig:WebDatePicker>
                                        </td>
                                        <td>
                                            <asp:DropDownList ID="ddlCondP3" runat="server" Font-Names="Verdana" Font-Size="8pt" Width="110px">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                            <asp:FileUpload ID="fuPDF3" runat="server" Font-Names="Verdana" Font-Size="8pt" Width="220px" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
