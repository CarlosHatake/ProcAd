<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="76.aspx.vb" Inherits="ProcAd._76" %>
                                ...
                                <table style="width: 1360px; height: 25px;">
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <asp:Label ID="lbl_EvalDir" runat="server" Font-Bold="True" ForeColor="White">EVALUACIONES AUTORIZADAS</asp:Label>
                                        </td>
                                        <td style="width: 150px; text-align: right;">
                                            &nbsp;</td>
                                        <td style="width: 130px;">
                            ...
                            <td>
                                <table style="width: 1320px; height: 35px;">
                                    <tr>
                                        ...
                                        <td style="text-align: center; width: 300px;">
                                            <asp:Button ID="btnAceptar" runat="server" Font-Names="Verdana" Font-Size="8pt" OnClick="btnAceptar_Click" OnClientClick="this.disabled = true; this.value='Procesando…';" Text="Enviar a Nómina" UseSubmitBehavior="false" Width="200px" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td>
                                <asp:GridView ID="gvEvaluaciones" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" Width="1320px">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="porcent_bono_cumpl_UN" HeaderText="porcent_bono_cumpl_UN" />
