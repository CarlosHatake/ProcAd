<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="89.aspx.vb" Inherits="ProcAd._89" %>
    ...
    <table style="width: 1366px; font-family: Verdana; font-size: 8pt;">
        <tr>
            <td style="text-align: center; color: #FF0000;">
                <ig:WebScriptManager ID="wsm89" runat="server">
                </ig:WebScriptManager>
                    ...
                    <table style="width: 1366px; height: 44px;">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top" colspan="3">
                                <asp:Label ID="lblLugar" runat="server" ForeColor="Blue" Width="750px"></asp:Label>
                            </td>
