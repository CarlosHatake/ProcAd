<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="CatLugar.aspx.vb" Inherits="ProcAd.CatLugar" %>
                            ...
                            <tr>
                                ...
                                <td style="width: 100px">
                                    <asp:DropDownList ID="ddlCampo" runat="server" Font-Names="Verdana" Font-Size="8pt" Width="110px">
                                        <asp:ListItem Value="lugar">Lugar</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 30px">
                        ...
                        <table style="width:100%;">
                            <tr>
                                ...
                                <td class="auto-style29">
                                    <asp:GridView ID="gvLugar" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" Width="450px">
                                        <AlternatingRowStyle BackColor="#CCCCCC" />
                                        <Columns>
                                            <asp:BoundField DataField="id_lugar" HeaderText="id_lugar">
                                        ...
                                        <table style="height: 28px; width: 100%;">
                                            <tr>
                                                <td style="text-align: right; width: 205px;">
                                                    <asp:Label ID="lbl_Lugar" runat="server" Font-Names="Verdana" Font-Size="8pt" Text="Lugar:"></asp:Label>
                                                </td>
                                                <td style="text-align: left; ">
                                                    <asp:TextBox ID="txtLugar" runat="server" Font-Names="Verdana" Font-Size="8pt" MaxLength="340" Width="450px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
