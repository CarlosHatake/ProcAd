<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="81.aspx.vb" Inherits="ProcAd._81" %>
        ...
        <tr>
            <td>
                <asp:Panel ID="pnlInicio" runat="server">
                    ...
                    <asp:Panel ID="pnlEvaluaciones" runat="server">
                        <table style="width: 1360px; height: 25px;">
                            <tr>
                    ...
                    <asp:Panel ID="pnlIndicadores" runat="server">
                        <table style="width: 1360px; height: 25px;">
                            <tr>
                                <td style="text-align: center; background-color: #4F81BD">
                                    <asp:Label ID="lbl_IndAsig0" runat="server" Font-Bold="True" ForeColor="White">INDICADORES ASIGNADOS</asp:Label>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table style="width:100%;">
                            <tr>
                                ...
                                <td style="text-align: left; ">
                                    <asp:Label ID="lblColaborador" runat="server" ForeColor="Blue" Width="280px"></asp:Label>
                                </td>
                            </tr>
                        </table>
                        <table style="width:100%;">
                        ...
                        <table style="width: 1360px; height: 50px;">
                            <tr>
                                <td style="text-align: center">
                                    <asp:Button ID="btnAceptarE" runat="server" Font-Names="Verdana" Font-Size="8pt" OnClick="btnAceptarE_Click" OnClientClick="this.disabled = true; this.value='Procesando…';" Text="Aceptar Evaluación" UseSubmitBehavior="false" Width="250px" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                    ...
                    <table style="width: 1360px; height: 50px;">
                        <tr>
                            <td style="text-align: center">
                                <asp:Button ID="btnAceptar" runat="server" Font-Names="Verdana" Font-Size="8pt" OnClick="btnAceptar_Click" OnClientClick="this.disabled = true; this.value='Procesando…';" Text="Enviar a Autorización" UseSubmitBehavior="false" Width="200px" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
