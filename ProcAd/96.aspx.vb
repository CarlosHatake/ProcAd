            ...
            With Me
                Try
                    ...
                    If Session("litError") = "" And Val(Session("id_usuario")) > 0 Then
                        ...
                        .txtComentario.Text = dsSol.Tables(0).Rows(0).Item("comentario_finanzas").ToString()
            ...
            Try
                ...
                Else
                    ...
                    While Val(._txtBan.Text) = 0
                        ...
                        Dim texto As String
                        texto = "<span style=""font-family:Verdana;font-size: 10pt;"">" + _
                                "La solicitud de Servicio Negociado número <b>" + .lblFolio.Text + "</b> no fue autorizada. <br>" + _
