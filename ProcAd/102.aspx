<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="102.aspx.vb" Inherits="ProcAd._102" %>
    ...
    <table style="width: 1366px; font-family: Verdana; font-size: 8pt;">
        <tr>
            <td style="text-align: center; color: #FF0000;">
                <ig:WebScriptManager ID="wsm102" runat="server">
                </ig:WebScriptManager>
                ...
                <asp:Panel ID="pnlInicio" runat="server">
                    ...
                    <table style="width: 1366px; height: 44px;">
                        ...
                        <tr>
                            ...
                            <td class="auto-style9">
                                <asp:Label ID="lblAutorizador1" runat="server" ForeColor="Blue"></asp:Label>
                            </td>
                            <td class="auto-style10" style="text-align: right; ">
