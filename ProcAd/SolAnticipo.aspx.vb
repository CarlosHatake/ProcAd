...
#Region "Botones"
    ...
    Protected Sub btnAgregarAdj_Click(sender As Object, e As EventArgs) Handles btnAgregarAdj.Click
        With Me
            Try
                ...
                ' Ruta en Atenea
                ' Dim sFileDir As String = "D:\ProcAd - Adjuntos AntProv\" 'Ruta en que se almacenará el archivo
    ...
    Protected Sub ibtnAltaPedidoC_Click(sender As Object, e As ImageClickEventArgs) Handles ibtnAltaPedidoC.Click
        With Me
            Try
                ...
                sdaSolicitud.SelectCommand.Parameters.AddWithValue("@id_pedido_compra", ddlPedidosCompra.SelectedItem.Value)
                sdaSolicitud.SelectCommand.Parameters.AddWithValue("@pedido_compra", ddlPedidosCompra.SelectedItem.Text)
    ...
    Protected Sub ddlPedidosCompra_SelectedIndexChanged(sender As Object, e As EventArgs)
        With Me
            Try
                If .ddlPedidosCompra.SelectedIndex = -1 Or ddlPedidosCompra.SelectedIndex = 0 Then
                    .ibtnAltaPedidoC.Enabled = False
                    .ibtnAltaPedidoC.ImageUrl = "images\Add_i2.png"
                Else
