<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="ContAntAud.aspx.vb" Inherits="ProcAd.ContAntAud" %>
                            ...
                            <td class="auto-style55">
                                <table style="width:100%;">
                                    ...
                                    <tr>
                                        <td style="width: 1px">&nbsp;</td>
                                        <td>
                                            <asp:GridView ID="gvRegistros" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" Width="1790px">
                                                <Columns>
                                                    <asp:BoundField DataField="no_anticipo" HeaderText="No. Anticipo">
                                                    <ItemStyle HorizontalAlign="Center" Width="50px" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Empresa" HeaderText="Emrpesa">
                                                    ...
                                                    <asp:BoundField DataField="fecha_solicitaC" HeaderText="Fecha Sol. Comp">
                                                    <ItemStyle HorizontalAlign="Center" Width="90px" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="fecha_autorizaC" HeaderText="Fecha Aut. Comp">
                                                    <ItemStyle HorizontalAlign="Center" Width="90px" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="fecha_aut_dirC" HeaderText="Fecha Aut. Dir. Comp">
                                                    <ItemStyle HorizontalAlign="Center" Width="90px" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="fecha_validaC" HeaderText="Fecha Valida Comp">
                                                    <ItemStyle HorizontalAlign="Center" Width="90px" />
                                                    </asp:BoundField>
