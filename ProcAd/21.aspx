<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="21.aspx.vb" Inherits="ProcAd._21" %>
    ...
    <table style="width: 1366px; font-family: Verdana; font-size: 8pt;">
        <tr>
            <td style="text-align: center; color: #FF0000;">
                <ig:WebScriptManager ID="wsm21" runat="server">
                </ig:WebScriptManager>
                ...
                <table style="width: 100%; height: 50px;">
                    <tr>
                        <td style="text-align: center">
                            <asp:Button ID="btnGuardar" runat="server" Font-Names="Verdana" Font-Size="8pt" Text="Entregar Vehículo al Usuario" Width="250px" OnClientClick="this.disabled = true;" UseSubmitBehavior="false" OnClick ="btnGuardar_Click" />
                        </td>
                    </tr>
                </table>
            </td>
