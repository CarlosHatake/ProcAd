<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="72.aspx.vb" Inherits="ProcAd._72" %>
    ...
    <table style="width: 1360px; font-family: Verdana; font-size: 8pt;">
        <tr>
            <td style="text-align: center; color: #FF0000;">
                <ig:WebScriptManager ID="wsm72" runat="server">
                </ig:WebScriptManager>
                    ...
                    <asp:Panel ID="pnlIndicadores" runat="server">
                        ...
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td style="text-align: center">
                                    <asp:TextBox ID="txtComentarioL" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="73px" MaxLength="340" TextMode="MultiLine" Width="500px" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td>&nbsp;</td>
                                <td style="text-align: center">
                                    <asp:TextBox ID="txtComentarioV" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="73px" MaxLength="340" TextMode="MultiLine" Width="500px"></asp:TextBox>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                        </table>
