                ...
                Try
                    ...
                    If Session("litError") = "" And Val(Session("id_usuario")) > 0 Then
                        ...
                        query = "select ms_negoc_servicio.id_ms_negoc_servicio " + _
                                ...
                                "     , lugar_ejecucion " + _
                                "     , ms_negoc_servicio.empleado_aut_negoc as autorizador " + _
                        ...
                        .txtComentario.Text = dsSol.Tables(0).Rows(0).Item("comentario_aut_cotiza").ToString()
        ...
        With Me
            Try
                ...
                While Val(._txtBan.Text) = 0
                    ...
                    SCMValores.CommandText = ""
                    SCMValores.Parameters.Clear()
                    SCMValores.CommandText = "update ms_negoc_servicio set id_usr_aut_cotiza = @id_usr_aut_cotiza, empleado_aut_cotiza = @empleado_aut_cotiza, fecha_aut_cotiza = @fecha_aut_cotiza, comentario_aut_cotiza = @comentario_aut_cotiza, ultimos_comentarios = @comentario_aut_cotiza, status = 'CotA' where id_ms_negoc_servicio = @id_ms_negoc_servicio "
                    SCMValores.Parameters.AddWithValue("@id_usr_aut_cotiza", Val(._txtIdUsuario.Text))
                    SCMValores.Parameters.AddWithValue("@empleado_aut_cotiza", ._txtNombreUsr.Text)
                    SCMValores.Parameters.AddWithValue("@fecha_aut_cotiza", fecha)
                    If .txtComentario.Text.Trim <> "" Then
                        SCMValores.Parameters.AddWithValue("@comentario_aut_cotiza", .txtComentario.Text.Trim)
                    Else
                        SCMValores.Parameters.AddWithValue("@comentario_aut_cotiza", DBNull.Value)
                    End If
                    ...
                    SCMValores.Parameters.AddWithValue("@id_actividad", 90)
                    ConexionBD.Open()
                    SCMValores.ExecuteNonQuery()
                    ConexionBD.Close()
                    ...
                    'Envío de Correo al Autorizador Técnico para la Negociación
                    Dim Mensaje As New System.Net.Mail.MailMessage()
                    Dim destinatario As String = ""
                    'Obtener el Correo del Autorizador Técnico para la Negociación
                    SCMValores.CommandText = "select cgEmpl.correo " + _
                                             "from ms_negoc_servicio " + _
                                             "  left join cg_usuario on ms_negoc_servicio.id_usr_aut_negoc = cg_usuario.id_usuario " + _
                    ...
                    Mensaje.Subject = "ProcAd - Solicitud de Negociación No. " + .lblFolio.Text + " Autorizada por Compras"
                    Dim texto As String
                    texto = "<span style=""font-family:Verdana;font-size: 10pt;"">" + _
                            "Se autorizó la cotización para la solicitud número <b>" + .lblFolio.Text + _
            ...
            Try
                ...
                Else
                    ...
                    While Val(._txtBan.Text) = 0
                        ...
                        SCMValores.CommandText = ""
                        SCMValores.Parameters.Clear()
                        SCMValores.CommandText = "update ms_negoc_servicio set id_usr_aut_cotiza = @id_usr_aut_cotiza, empleado_aut_cotiza = @empleado_aut_cotiza, comentario_aut_cotiza = @comentario_aut_cotiza, ultimos_comentarios = @comentario_aut_cotiza, status = 'P' where id_ms_negoc_servicio = @id_ms_negoc_servicio "
                        SCMValores.Parameters.AddWithValue("@id_usr_aut_cotiza", Val(._txtIdUsuario.Text))
                        SCMValores.Parameters.AddWithValue("@empleado_aut_cotiza", ._txtNombreUsr.Text)
                        SCMValores.Parameters.AddWithValue("@comentario_aut_cotiza", .txtComentario.Text.Trim)
                        SCMValores.Parameters.AddWithValue("@id_ms_negoc_servicio", Val(.lblFolio.Text))
