            ...
            With Me
                Try
                    ...
                    If Session("litError") = "" And Val(Session("id_usuario")) > 0 Then
                        ...
                        If Val(dsSol.Tables(0).Rows(0).Item("proveedor_selec").ToString()) = 0 Then
                        ...
                        ._txtCompras.Text = dsSol.Tables(0).Rows(0).Item("cCompras").ToString()
            ...
            Try
                ...
                Else
                    ...
                    While Val(._txtBan.Text) = 0
                        ...
                        SCMValores.CommandText = "update ms_factura set fecha_valida = @fecha_valida, comentario_valida = @comentario_valida, status = 'AV' where id_ms_factura = @id_ms_factura "
                        SCMValores.Parameters.AddWithValue("@fecha_valida", fecha)
                        SCMValores.Parameters.AddWithValue("@comentario_valida", .txtComentario.Text.Trim)
                        ...
                        If ._txtCompras.Text = "S" Then
                            'Requiere Cotizaciones, pasa con Compras
                            idActividad = 46
                        Else
            ...
            Try
                ...
                Else
                    ...
                    While Val(._txtBan.Text) = 0
                        ...
                        SCMValores.CommandText = ""
                        SCMValores.Parameters.Clear()
                        SCMValores.CommandText = "update ms_factura set fecha_valida = @fecha_valida, comentario_valida = @comentario_valida, status = 'ZV' where id_ms_factura = @id_ms_factura "
                        SCMValores.Parameters.AddWithValue("@fecha_valida", fecha)
                        SCMValores.Parameters.AddWithValue("@comentario_valida", .txtComentario.Text.Trim)
                        SCMValores.Parameters.AddWithValue("@id_ms_factura", Val(.lblFolio.Text))
                        ConexionBD.Open()
                        ...
                        SCMValores.CommandText = "update ms_instancia set id_actividad = @id_actividad where id_ms_instancia = @id_ms_instancia"
                        SCMValores.Parameters.AddWithValue("@id_ms_instancia", Val(._txtIdMsInst.Text))
                        SCMValores.Parameters.AddWithValue("@id_actividad", 45)
                        ConexionBD.Open()
                        SCMValores.ExecuteNonQuery()
                        ConexionBD.Close()
