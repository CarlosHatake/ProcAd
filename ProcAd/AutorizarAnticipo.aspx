<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="AutorizarAnticipo.aspx.vb" Inherits="ProcAd.AutorizarAnticipo" %>
                ...
                <asp:Panel runat="server" ID="pnlInicio">
                    ...
                    <table style="width: 1366px; height: 44px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <ig:WebDateTimeEditor ID="wdteFechaPagoAutorizar" runat="server" DisplayModeFormat="d" Font-Names="Verdana" Font-Size="8pt" Nullable="False" Width="75px">
                                </ig:WebDateTimeEditor>
                            </td>
                    ...
                    <table style="width: 1200px; height: 44px;">
                        <tr>
                            <td style="text-align: center">
                                <asp:Button ID="btnAutorizar" runat="server" Text="Autorizar" Width="200px" />
                            </td>
                            <td style="text-align:center">
                                <asp:Button ID="btnRechazar" runat="server" Text="Rechazar" Width="200px" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
