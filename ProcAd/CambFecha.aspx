<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="CambFecha.aspx.vb" Inherits="ProcAd.CambFecha" %>
    ...
    <table style="width: 1366px; font-family: Verdana; font-size: 8pt;">
        <tr>
            <td style="text-align: center; color: #FF0000;">
                <ig:WebScriptManager ID="wsmCambFecha" runat="server">
                </ig:WebScriptManager>
                <asp:Literal ID="litError" runat="server"></asp:Literal>
                <asp:TextBox ID="_txtIdMsVeh" runat="server" Width="15px" Visible="False"></asp:TextBox>
                ...
                <asp:Panel ID="pnlSolicitud" runat="server">
                    ...
                    <table style="width: 100%; height: 60px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <ig:WebDateTimeEditor ID="wdteFechaFin" runat="server" DisplayModeFormat="G" EditModeFormat="G" Font-Names="Verdana" Font-Size="8pt" Nullable="False" Width="155px">
                ...
                <table style="width: 100%; height: 50px;">
                    <tr>
                        <td style="text-align: center">
                            <asp:Button ID="btnGuardar" runat="server" Font-Names="Verdana" Font-Size="8pt" Text="Cambiar de Fecha de Regreso" Width="250px" />
                        </td>
                    </tr>
                </table>
            </td>
