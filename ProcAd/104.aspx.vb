            ...
            With Me
                Try
                    ...
                    If Session("litError") = "" And Val(Session("id_usuario")) > 0 Then
                        ...
                        sdaSol.SelectCommand = New SqlCommand("select id_ms_factura " +
                                                              "     , empleado " +
                                                              "     , empresa " +
            ...
            Try
                ...
                Else
                    ...
                    sdaDtFact.SelectCommand = New SqlCommand("select cantidad " + _
                                                             ...
                                                             "where uuid = @uuid " + _
                                                             "  and dt_factura_linea.movimiento in ('RECIBIDAS', 'RECIBIDA') " + _
            ...
            Try
                ...
                If ban = 0 Then
                    ...
                    Else
                        ...
                        SCMValores.Parameters.AddWithValue("@id_actividad", 102)
                        ConexionBD.Open()
                        SCMValores.ExecuteNonQuery()
                        ConexionBD.Close()
                        ...
                        SCMValores.Parameters.AddWithValue("@idAut", Val(._txtIdValidador2.Text))
                        ConexionBD.Open()
        ...
        With Me
            Try
                ...
                While Val(._txtBan.Text) = 0
                    ...
                    SCMValores.CommandText = "update ms_instancia set id_actividad = @id_actividad where id_ms_instancia = @id_ms_instancia"
                    SCMValores.Parameters.AddWithValue("@id_ms_instancia", Val(._txtIdMsInst.Text))
                    SCMValores.Parameters.AddWithValue("@id_actividad", 100)
                    ConexionBD.Open()
                    SCMValores.ExecuteNonQuery()
                    ConexionBD.Close()
