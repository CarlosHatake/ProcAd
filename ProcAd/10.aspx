<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="10.aspx.vb" Inherits="ProcAd._10" %>
    ...
    <table style="width: 1366px; font-family: Verdana; font-size: 8pt;">
        <tr>
            <td style="text-align: center; color: #FF0000; width: 1366px;">
                <ig:WebScriptManager ID="wsm10" runat="server">
                </ig:WebScriptManager>
        ...
        <tr>
            <td>
                <asp:Panel ID="pnlInicio" runat="server">
                    ...
                    <table style="width: 1366px; height: 63px;">
                        <tr>
                    ...
                    <table style="width: 1366px;">
                        <tr>
                            ...
                            <td style="width: 372px">
                                <asp:GridView ID="gvAnticipos" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" Width="370px">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="periodo_ini" DataFormatString="{0:d}" HeaderText="Fecha Inicio">
                    ...
                    <table style="width: 1366px;">
                        <tr>
                            ...
                            <td class="auto-style11">
                                <asp:TextBox ID="txtObs" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="43px" TextMode="MultiLine" Width="735px"></asp:TextBox>
                            </td>
                            <td class="auto-style10" style="text-align: right;">&nbsp;</td>
                            <td class="auto-style8">&nbsp;</td>
                        </tr>
                        <tr>
                            <td style="width: 150px; height: 25px; text-align: right">
                                <ig:WebCurrencyEditor ID="wceTotalPGV" runat="server" Visible="False" Width="30px">
                                </ig:WebCurrencyEditor>
                                <ig:WebCurrencyEditor ID="wceTotalA" runat="server" Visible="False" Width="30px">
                                </ig:WebCurrencyEditor>
                                <ig:WebCurrencyEditor ID="wceTotalC" runat="server" Visible="False" Width="30px">
                                </ig:WebCurrencyEditor>
                                <ig:WebCurrencyEditor ID="wceTotalS" runat="server" Visible="False" Width="30px">
                                </ig:WebCurrencyEditor>
                            </td>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td rowspan="2" style="width: 180px; text-align: center;">
                                            <asp:CheckBox ID="cbPagoEfect" runat="server" Text="Pagar Efectivo" />
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <td>
								...
								<asp:GridView ID="gvEvidencias" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Font-Names="Verdana" Font-Size="7pt" ForeColor="Black" GridLines="Horizontal" Width="200px">
                                    <Columns>
                                        ...
                                        <asp:HyperLinkField DataNavigateUrlFields="ruta" DataTextField="evidencia_adj" HeaderText="Nombre" />
                                        <asp:BoundField DataField="evidencia_adj" HeaderText="Nombre" Visible="false">
                                        <ItemStyle HorizontalAlign="Center" Width="70px" />
                                        </asp:BoundField>
                                    </Columns>
                        ...
                        <tr>
                            <td style="width: 150px; height: 25px; text-align: right">&nbsp;</td>
                            <td style="text-align: right;">
                    ...
                    <asp:Panel ID="pnlUnidad" runat="server">
                        <table style="width: 1366px;">
                            <tr>
                                <td style="width: 145px; height: 1px; text-align: right">&nbsp;</td>
                    ...
                    <table style="width:100%;">
                        <tr>
                            <td style="width: 5px; height: 30px; text-align: right">&nbsp;</td>
                            <td>
                                <asp:GridView ID="gvConceptos" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" GridLines="Vertical" Width="1345px">
                                    <AlternatingRowStyle BackColor="#CCCCCC" />
                                    <Columns>
                                        ...
                                        <ItemStyle HorizontalAlign="Right" Width="70px" />
										 ...
										 <asp:BoundField DataField="isr_ret" DataFormatString="{0:c}" HeaderText="Isr Ret">
                                        <ItemStyle HorizontalAlign="Right" Width="70px" />
                                        </asp:BoundField>
										...
										<asp:BoundField DataField="lugar_exp" HeaderText="C.P" />
                                        ...
                                        <asp:TemplateField HeaderText="No Válido" Visible="False">
                                            <ItemTemplate>
                    ...
                    <table style="width: 1366px; height: 50px;">
                        <tr>
                            <td style="text-align: center">
                                <asp:Button ID="btnGuardar" runat="server" Font-Names="Verdana" Font-Size="8pt" OnClick="btnGuardar_Click" OnClientClick="this.disabled = true;" Text="Registrar" UseSubmitBehavior="false" Width="200px" />
                            </td>
                            <td style="text-align: center; ">
                                <asp:Button ID="btnRegresar" runat="server" Font-Names="Verdana" Font-Size="8pt" OnClick="btnRegresar_Click" OnClientClick="this.disabled = true;" Text="Regresar" UseSubmitBehavior="false" Width="200px" Visible="False" />
                            </td>
                            <td style="text-align: center; ">
