            ...
            With Me
                Try
                    ...
                    If Session("litError") = "" And Val(Session("id_usuario")) > 0 Then
                        ...
                        sdaEmpresa.SelectCommand = New SqlCommand("select distinct(empresa) as empresa , id_empresa " +
                                                                  "from ms_presupuesto " +
                        ...
                        sdaCC.SelectCommand = New SqlCommand("select distinct(centro_costo) as centro_costo , id_cc " +
                                                             "from ms_presupuesto " +
    ...
    Protected Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        With Me
            Try
                ...
                sdaConsulta.SelectCommand.Parameters.AddWithValue("@año", Val(.ddlAño.SelectedValue))
                ...
                ElseIf cbEmpresa.Checked = False Then
                    sdaConsulta.SelectCommand.Parameters.AddWithValue("@empresa", DBNull.Value)
                End If

                If .cbCC.Checked = True Then
                    sdaConsulta.SelectCommand.Parameters.AddWithValue("@centro_costo", Val(.ddlCC.SelectedValue))
                ElseIf .cbCC.Checked = False Then
                    sdaConsulta.SelectCommand.Parameters.AddWithValue("@centro_costo", DBNull.Value)
                End If
