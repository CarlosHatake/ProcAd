        ...
        With Me
            Try
                ...
                While Val(._txtBan.Text) = 0
                    ...
                    SCMValores.CommandText = "update ms_factura set fecha_autoriza3 = @fecha_autoriza3, comentario_autoriza3 = @comentario_autoriza3, ultimos_comentarios = @comentario_autoriza3, status = 'A' where id_ms_factura = @id_ms_factura "
                    SCMValores.Parameters.AddWithValue("@fecha_autoriza3", fecha)
                    If .txtComentario.Text.Trim <> "" Then
                        SCMValores.Parameters.AddWithValue("@comentario_autoriza3", .txtComentario.Text.Trim)
                    Else
                        SCMValores.Parameters.AddWithValue("@comentario_autoriza3", DBNull.Value)
                    End If
            ...
            Try
                ...
                Else
                    ...
                    While Val(._txtBan.Text) = 0
                        ...
                        SCMValores.CommandText = ""
                        SCMValores.Parameters.Clear()
                        SCMValores.CommandText = "update ms_factura set fecha_autoriza = NULL, fecha_autoriza2 = NULL, fecha_autoriza3 = NULL, comentario_autoriza3 = @comentario_autoriza3, ultimos_comentarios = @comentario_autoriza3, status = 'Corr' where id_ms_factura = @id_ms_factura "
                        'SCMValores.Parameters.AddWithValue("@fecha_autoriza3", fecha)
                        SCMValores.Parameters.AddWithValue("@comentario_autoriza3", .txtComentario.Text.Trim)
                        SCMValores.Parameters.AddWithValue("@id_ms_factura", Val(.lblFolio.Text))
                        ConexionBD.Open()
