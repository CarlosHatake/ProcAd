<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="109.aspx.vb" Inherits="ProcAd._109" %>
    ...
    <table style="width: 1360px; font-family: Verdana; font-size: 8pt;">
        <tr>
            <td style="text-align: center; color: #FF0000;">
                ...
                <asp:TextBox ID="_txtCentroCosto" runat="server" Width="15px" Visible="False"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
                    ...
                    <table style="width: 1360px; height: 75px;">
                        <tr>
                            ...
                            <td class="auto-style9">
                                <asp:Label ID="lblUnidad" runat="server" ForeColor="Blue"></asp:Label>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblFecha" runat="server" ForeColor="Blue" Width="280px"></asp:Label>
                            </td>
                        </tr>
                        <tr>
