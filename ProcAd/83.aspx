<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="83.aspx.vb" Inherits="ProcAd._83" %>
                    ...
                    <table style="width: 100%; ">
                        <tr>
                            ...
                            <td style="width: 747px">
                                <asp:TextBox ID="txtEspecificaciones" runat="server" Height="79px" TextMode="MultiLine" Width="723px"></asp:TextBox>
                            </td>
                            <td class="auto-style10" style="text-align: right">
                            ...
                            <td style="width: 700px; vertical-align: top;">
                                <table style="width:100%;">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btnAgregarAdj" runat="server" Font-Names="Verdana" Font-Size="8pt" OnClick="btnAgregarAdj_Click" OnClientClick="this.disabled = true; this.value='Procesando…';" Text="Agregar Adjunto" UseSubmitBehavior="false" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td style="text-align: center">
                                <table style="width: 1366px; height: 50px;">
                                    <tr>
                                        <td style="text-align: center">
                                            <asp:Button ID="btnAceptar" runat="server" Font-Names="Verdana" Font-Size="8pt" OnClick="btnAceptar_Click" OnClientClick="this.disabled = true; this.value='Procesando…';" Text="Envíar a Compras" UseSubmitBehavior="false" Width="200px" />
                                        </td>
                                        <td style="text-align: center">
