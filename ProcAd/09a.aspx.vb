            ...
            Try
                ...
                Else
                    ...
                    While Val(._txtBan.Text) = 0
                        ...
                        SCMValoresNoVal.CommandText = "Declare @valorR int; Execute Sp_U_ms_comp09a   @id_ms_comp, @obs_autorizador, @id_ms_instancia, @id_actividad,  @id_usr,  @autorizador , @valorR output; Select @valorR"
                        'SCMValoresNoVal.CommandText = "update dt_comp " +
                        '                              "set no_valido = NULL " +
                        '                              "where id_ms_comp = @id_ms_comp "
                        SCMValoresNoVal.Parameters.AddWithValue("@id_ms_comp", Val(.lblFolio.Text))
                        If Val(._txtIdUsrAut.Text) = Val(._txtIdUsuario.Text) Then
                            If .txtObsAut.Text.Trim = "" Then
                                SCMValoresNoVal.Parameters.AddWithValue("@obs_autorizador", DBNull.Value)
                            Else
                                SCMValoresNoVal.Parameters.AddWithValue("@obs_autorizador", .txtObsAut.Text.Trim)
                            End If
                            SCMValoresNoVal.Parameters.AddWithValue("@autorizador", "S")

                        Else
                            SCMValoresNoVal.Parameters.AddWithValue("@autorizador", "N")
                        End If

                        SCMValoresNoVal.Parameters.AddWithValue("@id_ms_instancia", Val(._txtIdMsInst.Text))
                        SCMValoresNoVal.Parameters.AddWithValue("@id_actividad", 9)
                        SCMValoresNoVal.Parameters.AddWithValue("@id_usr", Val(._txtIdUsuario.Text))
                        ConexionBD.Open()
                        valor = SCMValoresNoVal.ExecuteScalar
                        ConexionBD.Close()
                        ...
                        If Val(._txtIdUsrAut.Text) = Val(._txtIdUsuario.Text) Then
                            ...
                            'SCMValores.CommandText = "update ms_comp set fecha_aut_val = @fecha_autoriza, obs_autorizador = @obs_autorizador where id_ms_comp = @id_ms_comp "
                ...
                Else
                    ...
                    Else
                        ...
                        While Val(._txtBan.Text) = 0
                            ...
                            SCMValores.CommandText = ""
                            SCMValores.Parameters.Clear()
                            SCMValores.CommandText = "Declare @valorR int; Execute Sp_U_ms_comp_ms_instancia09a   @obs_autorizador, @id_ms_comp, @autoriza, @id_actividad,  @id_ms_instancia,  @id_usr,  @valorR output; Select @valorR"
                            SCMValores.Parameters.AddWithValue("@obs_autorizador", .txtObsAut.Text.Trim)
                            SCMValores.Parameters.AddWithValue("@id_ms_comp", Val(.lblFolio.Text))
                            If Val(._txtIdUsrAut.Text) <> Val(._txtIdUsuario.Text) Then
                                SCMValores.Parameters.AddWithValue("@autoriza", "Segundo")
                            Else
                                SCMValores.Parameters.AddWithValue("@autoriza", "Primero")
                            End If
                            SCMValores.Parameters.AddWithValue("@id_ms_instancia", Val(._txtIdMsInst.Text))
        ...
        With Me
            Try
                ...
                While Val(._txtBan.Text) = 0
                    ...
                    SCMValores.CommandText = ""
                    SCMValores.Parameters.Clear()
                    SCMValores.CommandText = "Declare @valorR int; Execute Sp_D_ms_comp09a   @obs_autorizador, @id_ms_comp, @id_ms_instancia, @id_actividad,  @id_usr, @autoriza,  @valorR output; Select @valorR"
                    If Val(._txtIdUsrAut.Text) = Val(._txtIdUsuario.Text) Then
                        'Autorizador
                        ...
                        SCMValores.Parameters.AddWithValue("@autoriza", "Autorizador")
                    ...
                    Else
                        ...
                        SCMValores.Parameters.AddWithValue("@autoriza", "Director")
                    End If
                    If .txtObsAut.Text.Trim = "" Then
                        SCMValores.Parameters.AddWithValue("@obs_autorizador", DBNull.Value)
                    Else
