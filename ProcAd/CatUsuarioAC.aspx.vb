        ...
        With Me
            Try
                ...
                sdaCatalogo.SelectCommand = New SqlCommand("select cg_usuario.id_empleado " +
                                                           ...
                                                           "     , isnull(anticipo_proved, 'N') as anticipo_proved " +
                ...
                End If
                If dsCatalogo.Tables(0).Rows(0).Item("anticipo_proved").ToString() = "S" Then
                    cbAnticipoProv.Checked = True
                Else
                    cbAnticipoProv.Checked = False
                End If
        ...
        With Me
            Try
                ...
                If ban = 0 Then
                    ...
                    End If
                    If cbAnticipoProv.Checked = True Then
                        SCMValores.Parameters.AddWithValue("@anticipo_proved", "S")
                    Else
                        SCMValores.Parameters.AddWithValue("@anticipo_proved", "N")
                    End If
                    ConexionBD.Open()
