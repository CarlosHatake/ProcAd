<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pgMaestra.Master" CodeBehind="CatTHospedaje.aspx.vb" Inherits="ProcAd.CatTHospedaje" %>
                    ...
                    <table style="width: 100%; text-align: center; margin-right: auto; margin-left: auto; height: 60px;">
                        <tr>
                            ...
                            <td style="width: 120px">
                                <asp:DropDownList ID="ddlCampo" runat="server" Font-Names="Verdana" Font-Size="8pt" Width="120px">
                                    <asp:ListItem Value="tipo_hospedaje">Tipo Hospedaje</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td style="width: 30px">
                    ...
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td class="auto-style29">
                                <asp:GridView ID="gvTipoHospedaje" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" Width="500px">
                                    <AlternatingRowStyle BackColor="#CCCCCC" />
                                    <Columns>
                                        <asp:BoundField DataField="id_tipo_hospedaje" HeaderText="id_tipo_hospedaje">
                            ...
                            <td class="auto-style8">
                                <table style="width: 100%; height: 50px;">
                                    <tr>
                                        ...
                                        <td class="auto-style16" style="text-align: left; height: 25px; ">
                                            <asp:Label ID="lblTipoMov" runat="server" Font-Bold="True"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style14" style="text-align: right">
                                            <asp:Label ID="lbl_TipoHospedaje" runat="server" Text="Tipo Hospedaje:"></asp:Label>
                                        </td>
                                        <td class="auto-style16" style="text-align: left">
                                            <asp:TextBox ID="txtNombre" runat="server" Font-Names="Verdana" Font-Size="8pt" Width="550px" MaxLength="200"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                                <table style="width: 100%; height: 50px;">
